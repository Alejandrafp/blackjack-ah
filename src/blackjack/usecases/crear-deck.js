 ...
 * @param {Aray<String>} tiposDeCarta Ejemplo: ['C','D','H','S']
...
export const crearDeck = (tiposDeCarta, tiposEspeciales) => {
    ...
    if (!tiposEspeciales || tiposEspeciales.length === 0) throw new Error('TiposDeCarta es obligatorio como arreglo de string');
